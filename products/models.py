...
class Product(models.Model):
    ...
    price_unit      = models.CharField(max_length = 20, choices = PRICE_UNIT_CHOICES, default = 'Bag')
...
class MarketAgentProduct(models.Model):
    ...
    product_variety = models.ForeignKey(ProductVariety, on_delete = models.RESTRICT)
    ...
    price = models.DecimalField(max_digits = 15, decimal_places = 2, help_text = "Price per bag")
    PRICE_UNIT_CHOICES = (
        ('Bag', 'Bag'),
        ('Kg', 'Kg'),
        ('Tonn', 'Tonn'),
    ...
    price_unit = models.CharField(max_length = 30, choices = PRICE_UNIT_CHOICES, default = 'Bag')
