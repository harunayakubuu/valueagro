...
from .views import(
  ...
  market_agent_products_all, # Chairman, MD, DT Done
...
urlpatterns = [
    ...
    path('agents/products/all/', market_agent_products_all, name='market-agent-products-all'), # Director Technical, MD, Chairman
    path('agent/product/add/', market_agent_product_create, name='market-agent-product-create'),
    path('agent/products/list/', market_agent_products_list, name='market-agent-products-list'),
    path('csv-file/', get_csv_file, name='get-file'), # Director Technical, MD, Chairman
